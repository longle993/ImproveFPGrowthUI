function callFPGrowthAPI(smin) {
    const apiUrl = `https://localhost:7231/api/FPGrowth/duyet-hoa-don/${smin}`;
...
function displayFPGrowth() {
    ...
    submitButton.addEventListener('click', function() {
        callFPGrowthAPI(inputField.value);
    });
